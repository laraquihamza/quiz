...
class _PageQuizState extends State<PageQuiz>{
    ...
    return new Scaffold(
      ...
      body: new Center(
        child: new Column(
          ...
          children: [
            new CustomText("Question N°${index+1}", color: Colors.grey[900]),
  ...
  Future<Null> alerte() async{
    ...
    builder: (BuildContext buildContext){
      ...
      title: new CustomText("C'est fini",
  color: Colors.blue,
        factor: 1.25,
  ),
        contentPadding: EdgeInsets.all(10.0),
        content: new CustomText("Votre score: $score / ${index+1}", color:Colors.grey[900]),
        actions: [
          new FlatButton(
              onPressed: (){
